...
2 - check Main method where all methods called
3 - impelmented TransactionDataFetcherTest test class where all unit test cases (positive and negative) defined for all methods , used ummy data which is available in Testutil class